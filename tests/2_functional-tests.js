...
suite('Functional Tests', () => {
    ...
    test('(1)A valid puzzle string', (done) => {
      chai
        ...
        .end((err, res) => {
          ...
          assert.deepEqual(res.body, { solution: solutionForValid })
          done()
        })
    })
  ...
  suite('POST /api/check', () => {
    ...
    test('(9)With three conflict', (done) => {
      const input = { puzzle: validPuzzle, coordinate: 'G4', value: '3' }
    ...
    test('(12)With incorrect length puzzle ', (done) => {
      const input = { puzzle: invalidLengthPuzzle, coordinate: 'A2', value: '7',}
